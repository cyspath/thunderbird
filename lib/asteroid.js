(function () {
  ...
  Asteroid.prototype.preload = function () {
    this.asteroidImage = new Image();
    this.asteroidImage.src = "assets/images/asteroids.png"
  };
  ...
  Asteroid.prototype.draw = function () {
    ...
    // ctx.fill();
      ...
      ctx.drawImage(this.asteroidImage, 0, this.sy, 64, 64, this.pos[0] - 30, this.pos[1] - 30, 64, 64);
